    ...
    <div>
        ...
        <div className="w-11/12 mx-auto px-4 text-center">
          <div className="">
            ...
            {/* Main Title */}
            <h2 className="text-3xl font-semibold bg-gradient-to-r from-purple-500 to-pink-500 bg-clip-text text-transparent">
       ...
       {/* Process Cards Grid */}
       <div className="grid grid-cols-4 gap-6 mt-8 w-11/12 mx-auto">
